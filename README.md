...
[![My Skills](https://skillicons.dev/icons?i=js,ts,svelte,nuxtjs,nodejs,vuejs,express,react,nextjs,html,css,python,tailwind,mongodb,mysql,figma,aws,,gcp,linux,git,vite,postman)](https://skillicons.dev)
